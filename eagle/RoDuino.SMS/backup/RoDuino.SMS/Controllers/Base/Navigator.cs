                    ...
                    catch (Exception exception)
                    {
                        RoLog.Instance.WriteToLog(
                            String.Format(
                                ...
                                exception.GetType(),
                                exception.Message, exception.StackTrace, replace, exception));
                    }
                    ...
                    catch (Exception exception)
                    {
                        RoLog.Instance.WriteToLog(
                            String.Format(
                                ...
                                exception.InnerException.Message, exception.InnerException.StackTrace, name, exception));
                    }
                }
            }
        }
